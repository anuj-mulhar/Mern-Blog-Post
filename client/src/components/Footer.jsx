      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <Footer.LinkGroup col>
                <Footer.Link 
                href='https://github.com/anuj-mulhar'
                target="_blank" 
                rel = 'noopener noreferrer'
                >
                    Github
                ...
                <Footer.Link 
                href='https://www.linkedin.com/in/anuj-mulhar-a294b5231?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"'
                target="_blank" 
                rel = 'noopener noreferrer'
                >
                    LinkedIn
